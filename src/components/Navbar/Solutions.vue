<template>
  <div class="nav-height text-primary text-sm max-width">
    <div class="hidden xl:block">
      <div
        class="mx-16 pt-6 pb-8 flex justify-between"
    ...
    <div class="block font-semibold xl:hidden">
      <div class="mt-10 px-8 flex flex-col" style="min-height:inherit">
        ...
        <div class="w-full">
          <ul>
            <h4 class="uppercase font-bold tracking-widest text-gray-800 mb-6">
              customer stories
            </h4>
            <ul class="flex font-semibold uppercase items-center my-2">
              <router-link :to="'/'">
